...
TERRA_GCP_BILLING_SCHEMA = [
    ...
    SchemaField(
        ...
        fields=[
            ...
            SchemaField(
                ...
                fields=[
                    SchemaField(
                        name="resource_name", field_type="STRING", mode="NULLABLE"
                    ),
                    SchemaField(
                        name="display_name", field_type="STRING", mode="NULLABLE"
                    ),
                ],
            ),
        ],
    ...
    SchemaField(
        ...
        fields=[
            ...
            SchemaField(
                name="amount_in_pricing_units", field_type="FLOAT", mode="NULLABLE"
            ),
